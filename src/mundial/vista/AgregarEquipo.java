...
public class AgregarEquipo extends java.awt.Dialog {
    ...
    private void initComponents() {
        ...
        txtPuntosRankin.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtPuntosRankinKeyTyped(evt);
            }
        });

        lblUbicacionRankin.setText("Ubicacion Rankin");

        txtUbicacionRankin.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtUbicacionRankinKeyTyped(evt);
            }
        });
        ...
        txtTitulosGanados.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtTitulosGanadosKeyTyped(evt);
            }
        });
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        equipo = dequipo.encontrarPorId(txtCodigo.getText());
        if (txtEquipo.getText() != null && txtUbicacionRankin.getText() != null && txtPuntosRankin.getText() != null && txtTitulosGanados.getText() != null && obtenerContinente() != null && obtenerGrupo() != null && obtenerResultadoPF1() != null && obtenerResultadoPF2() != null && obtenerResultadoPF3() != null) {
            if (equipo == null) {
                ...
                equi.setContinente(c);
                equi.setGrupo(g);
                equi.setP_final1(pf1);
                equi.setP_final2(pf2);
                equi.setP_final3(pf3);
                dequipo.persistir(equi);
                JOptionPane.showMessageDialog(null, "EL EQUIPO HA SIDO GUARDADO CON EXITO");
                txtCodigo.setText("");
                txtEquipo.setText("");
                ...
                JOptionPane.showMessageDialog(null, "EL EQUIPO YA EXISTE !POR FAVOR INGRESE OTRO DIFERENTE!");
    ...
    private void txtUbicacionRankinKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtUbicacionRankinKeyTyped
       char car = evt.getKeyChar();
        if ((car < '0' || car > '9')) {
            evt.consume();
        }
    }//GEN-LAST:event_txtUbicacionRankinKeyTyped

    private void txtTitulosGanadosKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTitulosGanadosKeyTyped
        char car = evt.getKeyChar();
        if ((car < '0' || car > '9')) {
            evt.consume();
        }
    }//GEN-LAST:event_txtTitulosGanadosKeyTyped

    private void txtPuntosRankinKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPuntosRankinKeyTyped
        char car = evt.getKeyChar();
        if ((car < '0' || car > '9')) {
            evt.consume();
        }
    }//GEN-LAST:event_txtPuntosRankinKeyTyped
...
//            public void run() {
//                AgregarEquipo dialog = new AgregarEquipo(new java.awt.Frame(), true);
